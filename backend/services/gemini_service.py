...
"""
    ...
    for model_name in models_to_try:
        try:
            ...
            return await finalize_timeline_from_parsed(parsed_data, prompt, grounding_payload)
...
"""
    ...
    for model_name in models_to_try:
        try:
            ...
            return await finalize_timeline_from_parsed(parsed_data, subject_label, mark_personal=True)
