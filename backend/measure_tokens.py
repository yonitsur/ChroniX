...
Usage:
    python backend/measure_tokens.py "נושא לציר זמן" [--grounding]
    python backend/measure_tokens.py "The History of Ancient Rome"
"""
...
async def main():
    ...
    parser.add_argument("prompt", nargs="?", default="ההיסטוריה המלאה של האימפריה הרומית - מקיף ומפורט 50 אירועים", help="Topic for the timeline")
