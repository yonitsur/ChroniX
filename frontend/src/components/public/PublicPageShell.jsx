...
export default function PublicPageShell({
  ...
  return (
    <div
      className="auth-gate-bg home-bg-particles fixed inset-0 w-full h-full h-[100dvh] text-ink flex flex-col selection:bg-accent-soft selection:text-accent bg-cover overflow-hidden"
      dir={isRtl ? 'rtl' : 'ltr'}
    >
