...
export default function GeoMapView({
  ...
  const getPinColor = (art) => {
    ...
    return laneColorMap[art.lane] || '#0284c7';
  };
  ...
  }, [filteredGeoArticles, laneColorMap, themedMode, categories, selectedArticleId, isMobile, isExploring, isRtl]);
  ...
  return (
    <div className={`relative w-full h-full overflow-hidden select-none bg-surface-sunken ${className}`}>
      ...
      {nonGeoActiveArticle && (() => {
        ...
        const badgeLabel = themedMode && nonGeoActiveArticle.category
          ? nonGeoActiveArticle.category
          : (lanes.find((l) => l.id === nonGeoActiveArticle.lane)?.title || '');
        ...
        return (
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider text-warning mb-1.5 pr-6 rtl:pr-0 rtl:pl-6">
              ...
              {/* Event number & Date */}
              {(eventNum || yearStr) && (
                <div className="flex items-center gap-1.5 text-[10px] font-semibold text-accent uppercase tracking-wider mb-0.5">
              ...
              {nonGeoActiveArticle.subtitle && (
                <p className="text-[11px] text-ink-muted leading-tight mb-2 line-clamp-2">
                  {nonGeoActiveArticle.subtitle}
                </p>
              )}
              ...
              {nonGeoActiveArticle.wikiUrl && (
                <div className="flex items-center gap-2 pt-2 mt-1 border-t border-line">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-1.5 px-2.5 text-[11px] font-medium rounded-control bg-surface-raised hover:bg-surface-hover text-ink hover:text-accent border border-line transition-colors cursor-pointer shadow-control group"
                  >
              ...
              <button
                ...
                className="w-full mt-2 flex items-center justify-center gap-1 py-1.5 px-2 text-[10px] font-semibold rounded-control bg-accent-soft hover:bg-accent-soft/80 text-accent border border-accent/40 transition-colors cursor-pointer"
              >
                <span>{t('eventDrawer.title')}</span>
