...
export default function ChroniXLogo({ 
  ...
  const textColorClass = isForcedDark
    ...
    : isForcedLight
    ? "fill-ink"
    : "fill-ink dark:fill-white transition-colors";

  const axisColorClass = isForcedDark
    ? "text-ink-subtle"
    : isForcedLight
    ? "text-ink-subtle"
    : "text-ink-faint dark:text-ink-subtle";
        ...
        >
          <defs>
            <linearGradient id="chronix-x-grad-min" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="100%" stopColor="#2563a2" />
            </linearGradient>
          </defs>
      ...
      >
        <defs>
          ...
          <linearGradient id="chronix-dot-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#6ea8e0" />
            <stop offset="100%" stopColor="#1e4f82" />
          </linearGradient>
        </defs>

        {/* Origin dot */}
        <circle cx="9" cy="27" r="3.2" fill="#6ea8e0" />
  ...
  if (effectiveMode === 'minimal') {
    return (
      ...
      >
        ...
        >
          <tspan
            fill={isForcedDark ? "#ffffff" : isForcedLight ? "#18181b" : "currentColor"}
            className={textColorClass}
          >
            Chroni
          </tspan>
