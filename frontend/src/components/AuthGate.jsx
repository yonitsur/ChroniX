                ...
                <div className="lg:col-span-5 flex justify-center w-full">
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center mb-4">
                      ...
                      <span className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm border border-line/40 dark:border-white/10 px-3 text-caption uppercase tracking-wider text-ink-subtle font-medium shrink-0 rounded-full">
                        {t('auth.orEmail')}
                      </span>
                      <div className="border-t border-line/60 dark:border-white/10 w-full" />
                    </div>
