...
import { getDistinctCategories, getLaneColor, getCategoryColor } from '../data/laneColors';
          ...
          {options.map((opt) => {
            ...
            return (
              <button
                ...
                className={`w-full px-3 py-1.5 text-xs flex items-center gap-2 transition-colors cursor-pointer text-start ${
                  isActive ? 'bg-accent-soft text-accent font-semibold' : 'text-ink hover:bg-surface-hover'
                }`}
              >
                <span
                  className="w-2.5 h-2.5 rounded-full shrink-0 shadow-2xs"
...
export default function EventEditModal({
  ...
  const laneOptions = [
    ...
    ...lanes.map((l, idx) => ({ value: l.id, label: l.title, color: getLaneColor(l, idx, lanes) })),
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4 text-sm text-ink">
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full h-20 max-h-20 resize-none overflow-y-auto bg-surface-sunken border border-line rounded-control px-3 py-2 text-ink placeholder-ink-faint outline-none focus:border-accent focus:ring-1 focus:ring-accent-ring/30 text-sm shadow-control ${
          ...
          <div className="pt-3 border-t border-line/60">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <label
                ...
                className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-control text-xs font-medium border transition-colors shadow-control ${
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full h-32 resize-y overflow-y-auto bg-surface-sunken border border-line rounded-control px-3 py-2 text-ink placeholder-ink-faint outline-none focus:border-accent text-xs leading-relaxed shadow-control ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-surface-sunken border border-line rounded-control px-3 py-1.5 text-ink placeholder-ink-faint outline-none focus:border-accent text-xs shadow-control ${
                    (sourceName ? /[\u0590-\u05FF\u0600-\u06FF]/.test(sourceName) : isRtl) ? 'text-right' : 'text-left'
                  }`}
                />
              </div>
