        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4 text-sm text-ink">
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full h-20 resize-y overflow-y-auto bg-surface-sunken border border-line rounded-control px-3 py-2 text-ink placeholder-ink-faint outline-none focus:border-accent focus:ring-1 focus:ring-accent-ring/30 text-sm shadow-control ${
