  ...
  theme: {
    extend: {
      fontSize: {
        ...
        display: ['clamp(2rem, 4vw + 1rem, 3.5rem)', { lineHeight: '1.1', fontWeight: '600' }],
        // H1 (Page Title): Desktop 2.25rem (36px), Mobile 1.75rem-2rem (28px-32px) | line-height: 1.2 | font-weight: 600
        h1: ['clamp(1.75rem, 2vw + 1rem, 2.25rem)', { lineHeight: '1.2', fontWeight: '600' }],
      ...
      fontFamily: {
        ...
        brand: ['"Outfit"', '"Plus Jakarta Sans"', 'Inter', 'sans-serif'],
        cinzel: ['"Cinzel"', 'serif'],
      },
      colors: {
        ...
        // Legacy dark-only ramp, now aliased to the semantic surface tokens so
        // remaining `dark:bg-obsidian-*` classes stay in sync with the palette.
        obsidian: {
          DEFAULT: 'rgb(var(--surface-sunken) / <alpha-value>)',
          base: 'rgb(var(--surface-sunken) / <alpha-value>)',
      ...
      boxShadow: {
        // Semantic elevation - values live in index.css so each theme gets
        // its own tuning (light: soft spread; dark: deeper + top highlight).
        control: 'var(--shadow-control)',
        '2xs': '0 1px 1px 0 rgb(0 0 0 / 0.04)',
        card: 'var(--shadow-card)',
        pop: 'var(--shadow-pop)',
        panel: 'var(--shadow-panel)',
        // Legacy names kept as aliases of the semantic scale.
        'glass-sm': 'var(--shadow-card)',
        'glass-md': 'var(--shadow-pop)',
        'glass-lg': 'var(--shadow-panel)',
        // Former glows are now quiet focus-style rings, no blur halo.
        'glow-accent': '0 0 0 3px rgb(var(--ink) / 0.10)',
        'glow-star': '0 0 0 3px rgb(var(--star) / 0.18)',
        'glow-subtle': 'none',
        'inner-highlight': 'var(--shadow-inset-hi)',
      },
      backdropBlur: {
        xs: '2px',
        sm: '4px',
      ...
      keyframes: {
        ...
        'pulse-gentle': {
          ...
          '50%': { opacity: '0.84', transform: 'scale(0.98)' },
        },
      },
      animation: {
